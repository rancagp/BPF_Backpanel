...
@section('namaPage', 'Ubah Kategori Wakil Pialang')
...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <div class="d-flex align-items-center">
            ...
            <h5 class="m-0 font-weight-bold">Form Ubah Kategori</h5>
        </div>
    </div>
    <div class="card-body">
        <form id="kategoriForm" action="{{ route('kategori-wakil.update', $kategori->id) }}" method="POST">
            @csrf
            @method('PUT')
            <!-- Menandakan form ini untuk update -->
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-success" form="kategoriForm">Ya, Update</button>
            </div>
        </div>
    </div>
</div>
